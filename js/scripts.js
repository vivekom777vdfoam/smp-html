/*$(window).bind('beforeunload', function() {
  ...
  // setTimeout('window.location.href="http://google.com";',100);
...
$(document).ready(function() {
  ...
  // var abcd = "<meta http-equiv="refresh" content="0; URL='http://192.168.1.12/smp-html/'" />";
  if (true) {
    // $('head').append(<meta http-equiv="refresh" content="0; URL='http://192.168.1.12/smp-html/'" />);
  }
});
